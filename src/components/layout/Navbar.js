      ...
      <ul className="right hide-on-med-and-down">
        ...
        {appState.isAuthenticated && (
          <>
            ...
            <li><a href="#messages" className="btn-floating accent-4 z-depth-0 modal-trigger" style={{backgroundColor:'#004e86'}}>
    ...
    <ul className={`collection ${mobileNavbar?"hide-on-large-only":"hide"}`}>
        ...
        {appState.isAuthenticated && (
          <>
            ...
            <li className="collection-item"><a href="#messages" className="btn-floating darken-4 z-depth-0 modal-trigger" style={{backgroundColor:'#004e86'}}>
              <i className="material-icons">notifications</i>
